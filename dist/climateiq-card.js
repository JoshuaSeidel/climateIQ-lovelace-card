 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),r=new WeakMap;let o=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=r.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&r.set(e,t))}return t}toString(){return this.cssText}};const n=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new o("string"==typeof t?t:t+"",void 0,s))(e)})(t):t,{is:a,defineProperty:c,getOwnPropertyDescriptor:l,getOwnPropertyNames:d,getOwnPropertySymbols:h,getPrototypeOf:p}=Object,u=globalThis,_=u.trustedTypes,g=_?_.emptyScript:"",v=u.reactiveElementPolyfillSupport,f=(t,e)=>t,m={toAttribute(t,e){switch(e){case Boolean:t=t?g:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},b=(t,e)=>!a(t,e),$={attribute:!0,type:String,converter:m,reflect:!1,useDefault:!1,hasChanged:b};
/**
 * @license
...
`;window.customCards=window.customCards||[],window.customCards.push({type:"climateiq-card",name:"ClimateIQ Card",description:"AI-powered climate management dashboard card"});let ut=class extends nt{constructor(){super(...arguments),this._zones=[],this._systemConfig=null,this._override=null,this._loading=!0,this._error=null,this._overrideTemp=null,this._addonSlug="local_climateiq",this._ingressBase="",this._ingressResolved=!1,this._ingressSession=""}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={title:"ClimateIQ",show_zones:!0,show_quick_actions:!0,show_override:!0,...t},t.addon_slug&&(this._addonSlug=t.addon_slug)}getCardSize(){let t=3;return this._config?.show_override&&(t+=2),this._config?.show_zones&&this._zones.length&&(t+=this._zones.length),this._config?.show_quick_actions&&(t+=2),t}connectedCallback(){super.connectedCallback(),this._startRefresh()}disconnectedCallback(){super.disconnectedCallback(),this._stopRefresh()}updated(t){super.updated(t),t.has("hass")&&this.hass&&!this._ingressResolved&&this._resolveIngress()}async _resolveIngress(){if(this._ingressResolved)return;const t=this._config?.addon_slug;let e=null,i=null,s=null;const r=this.hass.callWS({type:"supervisor/api",endpoint:"/ingress/session",method:"post"}).catch(()=>null),o=t?Promise.resolve(t):this.hass.callWS({type:"supervisor/api",endpoint:"/addons",method:"get"}).then(t=>{const e=t?.addons??[],i=e.find(t=>"local_climateiq"===t.slug)||e.find(t=>/climateiq/i.test(t.slug))||e.find(t=>/climateiq/i.test(t.name??""));if(i)return i.slug;const r=e.filter(t=>t.slug?.startsWith("local_")).map(t=>`${t.slug} (${t.name})`).join(", ");return s=r?`ClimateIQ addon not found. Set addon_slug in card config. Local addons found: ${r}`:"ClimateIQ addon not found and no local addons are installed. Set addon_slug in card config.",null}).catch(()=>null);if([e,i]=await Promise.all([r,o]),s)return this._ingressResolved=!0,this._loading=!1,void(this._error=s);e?.session&&(this._ingressSession=e.session,document.cookie=`ingress_session=${e.session};path=/api/hassio_ingress/;SameSite=Strict${"https:"===location.protocol?";Secure":""}`),i&&(this._addonSlug=i);try{const t=await this.hass.callWS({type:"supervisor/api",endpoint:`/addons/${this._addonSlug}/info`,method:"get"});t?.ingress_url&&(this._ingressBase=t.ingress_url.replace(/\/$/,""))}catch{}this._ingressResolved=!0,this._fetchAll()}async _refreshIngressSession(){if(this._ingressSession)try{await this.hass.callWS({type:"supervisor/api",endpoint:"/ingress/validate_session",method:"post",data:{session:this._ingressSession}})}catch{this._ingressResolved=!1,this._ingressSession="",this._resolveIngress()}}async _fetchApi(t){if(!this._ingressBase)throw new Error("Ingress not resolved");const e=`${this._ingressBase}/api/v1${t}`,i=await fetch(e,{headers:{"Content-Type":"application/json"},credentials:"same-origin"});if(!i.ok)throw new Error(`API ${i.status}`);return i.json()}async _postApi(t,e){if(!this._ingressBase)throw new Error("Ingress not resolved");const i=`${this._ingressBase}/api/v1${t}`,s=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},credentials:"same-origin",body:JSON.stringify(e)});if(!s.ok)throw new Error(`API ${s.status}`);return s.json()}async _fetchAll(){if(this.hass&&this._ingressBase){this._refreshIngressSession();try{const[t,e,i]=await Promise.all([this._fetchApi("/zones").catch(()=>[]),this._fetchApi("/system/config").catch(()=>null),this._fetchApi("/system/override").catch(()=>null)]);this._zones=t,this._systemConfig=e;const s=this._override?.schedule_target_temp??null;s!==(i?.schedule_target_temp??null)&&(this._overrideTemp=null),this._override=i,null==this._overrideTemp&&(this._overrideTemp=i?.schedule_target_temp??i?.target_temp??null),this._loading=!1,this._error=null}catch(t){this._loading=!1,this._error=t instanceof Error?t.message:"Failed to connect to ClimateIQ add-on"}}}_startRefresh(){this._stopRefresh(),this._refreshInterval=window.setInterval(()=>this._fetchAll(),15e3)}_stopRefresh(){null!=this._refreshInterval&&(clearInterval(this._refreshInterval),this._refreshInterval=void 0)}async _handleQuickAction(t){if(this._canControl)try{await this._postApi("/system/quick-action",{action:t}),setTimeout(()=>this._fetchAll(),500)}catch{}}_handleTempAdjust(t){this._canControl&&(null==this._overrideTemp&&(this._overrideTemp=this._override?.schedule_target_temp??this._override?.target_temp??72),this._overrideTemp=Math.round(10*(this._overrideTemp+t))/10)}async _handleOverrideSubmit(){if(this._canControl&&null!=this._overrideTemp)try{await this._postApi("/system/override",{temperature:this._overrideTemp}),setTimeout(()=>this._fetchAll(),500)}catch{}}get _canControl(){const t=this._config?.allowed_users;if(!t||0===t.length)return!1;const e=this.hass?.user;if(!e)return!1;if(e.is_admin)return!0;const i=(e.name??"").toLowerCase();return t.some(t=>t.toLowerCase()===i)}get _tempUnit(){return(this.hass?.config?.unit_system?.temperature??"").includes("C")?"°C":"°F"}_celsiusToDisplay(t){return null==t?null:"°F"===this._tempUnit?9*t/5+32:t}_formatTemp(t){return null==t?"--":Math.round(t).toString()}_modeLabel(t){if(!t)return"Unknown";return{learn:"Learning",scheduled:"Scheduled",follow_me:"Follow Me",active:"Active"}[t]||t.charAt(0).toUpperCase()+t.slice(1)}render(){return this._config?D`
    ...
    `}_renderThermostat(){const t=this._override,e=t?.hvac_mode||"off",i=this._tempUnit,s=null!=t?.schedule_avg_temp?t.schedule_avg_temp:(()=>{const t=this._zones.filter(t=>null!=t.current_temp);return t.length>0?t.reduce((t,e)=>t+this._celsiusToDisplay(e.current_temp),0)/t.length:null})(),r=t?.schedule_target_temp??t?.target_temp??null;return D`
      <div class="ciq-thermostat">
        <div class="ciq-current-temp">
          ${this._formatTemp(s)}<span class="unit">${i}</span>
        </div>
        <div class="ciq-target-row">
          <span class="ciq-target-label">Target</span>
          <span class="ciq-target-temp">
            ${this._formatTemp(r)}${i}
          </span>
        </div>
        <div class="ciq-hvac-mode ${e}">${e.toUpperCase()}</div>
      </div>
    `}_renderOverride(){const t=this._override,e=this._tempUnit,i="°C"===this._tempUnit?.5:1,s=t?.schedule_target_temp??t?.target_temp??null,r=this._overrideTemp??s,o=t?.is_override_active??!1,n=this._canControl&&null!=r&&r!==s,a=this._canControl;return D`
      <div class="ciq-divider"></div>
      <div class="ciq-section-label">Manual Override</div>
      ${o?D`<div class="ciq-override-active">Override Active</div>`:Q}
      <div class="ciq-override">
        ...
        <div class="ciq-override-value">
          ${this._formatTemp(r)}<span class="unit">${e}</span>
        </div>
        <button
          class="ciq-override-btn"
          ?disabled=${!a}
    ...
    `}};ut.styles=pt,t([dt({attribute:!1})],ut.prototype,"hass",void 0),t([ht()],ut.prototype,"_config",void 0),t([ht()],ut.prototype,"_zones",void 0),t([ht()],ut.prototype,"_systemConfig",void 0),t([ht()],ut.prototype,"_override",void 0),t([ht()],ut.prototype,"_loading",void 0),t([ht()],ut.prototype,"_error",void 0),t([ht()],ut.prototype,"_overrideTemp",void 0),ut=t([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("climateiq-card")],ut);export{ut as ClimateIQCard};
